...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("MNT", "userauthorization", "userauthorization", "codua", "codpsw", "MNT", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL MNT TABAUX UserAuthorization]/
