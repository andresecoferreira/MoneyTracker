...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// System id
        /// </summary>
        public static string Program { get; } = "MNT";

        /// <summary>
        /// Application subsystem
        /// </summary>
        public static readonly ClientApplication Application = ClientApplication.MNT;

        /// <summary>
        /// Modules
        /// </summary>
        public static readonly List<string> Modules = ["MNT"];
        ...
        {
			// USE /[MANUAL MNT RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
