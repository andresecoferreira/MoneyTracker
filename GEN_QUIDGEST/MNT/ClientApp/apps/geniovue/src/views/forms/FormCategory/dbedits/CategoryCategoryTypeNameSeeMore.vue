<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-category-category-type-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CATEGORY__CATEGORY_TYPE__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'CategoryCategoryTypeNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CATEGORY__CATEGORY_TYPE__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'CATEGORY__CATEGORY_TYPE__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CATEGORY__CATEGORY_TYPE__NAME_SeeMore',
					name: 'CATEGORY__CATEGORY_TYPE__NAME_SeeMore',
					controller: 'CATEGORY',
					action: 'CATEGORY_Category_typeValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-category-category-type-name',
				dismissAction: this.close,
				returnElement: 'CATEGORY__CATEGORY_TYPE__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-category-category-type-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Category_Category_typeValName',
							serverMode: true,
						...
						uuid: 'Category_Category_Category_typeValName',
