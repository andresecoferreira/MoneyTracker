<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-expense-category-type-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EXPENSE__CATEGORY_TYPE__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ExpenseCategoryTypeNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EXPENSE__CATEGORY_TYPE__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'EXPENSE__CATEGORY_TYPE__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EXPENSE__CATEGORY_TYPE__NAME_SeeMore',
					name: 'EXPENSE__CATEGORY_TYPE__NAME_SeeMore',
					controller: 'EXPENSE',
					action: 'EXPENSE_Category_typeValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-expense-category-type-name',
				dismissAction: this.close,
				returnElement: 'EXPENSE__CATEGORY_TYPE__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-expense-category-type-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Expense_Category_typeValName',
							serverMode: true,
						...
						uuid: 'Expense_Expense_Category_typeValName',
