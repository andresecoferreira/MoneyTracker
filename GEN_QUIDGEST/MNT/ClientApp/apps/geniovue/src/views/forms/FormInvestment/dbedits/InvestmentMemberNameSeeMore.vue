<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-investment-member-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['INVESTMENT__MEMBER__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'InvestmentMemberNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('INVESTMENT__MEMBER__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'INVESTMENT__MEMBER__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'INVESTMENT__MEMBER__NAME_SeeMore',
					name: 'INVESTMENT__MEMBER__NAME_SeeMore',
					controller: 'INVESTMENT',
					action: 'INVESTMENT_MemberValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-investment-member-name',
				dismissAction: this.close,
				returnElement: 'INVESTMENT__MEMBER__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-investment-member-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Investment_Investment_MemberValName',
