...
public class MNT_Menu_331_RowViewModel : Models.Investment
{
	#region Constructors

	public MNT_Menu_331_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public MNT_Menu_331_RowViewModel(UserContext userContext, CSGenioAinvestment val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
