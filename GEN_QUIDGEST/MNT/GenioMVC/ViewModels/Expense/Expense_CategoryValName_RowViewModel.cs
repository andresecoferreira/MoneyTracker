...
public class Expense_CategoryValName_RowViewModel : Models.Category
{
	#region Constructors

	public Expense_CategoryValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Expense_CategoryValName_RowViewModel(UserContext userContext, CSGenioAcategory val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
