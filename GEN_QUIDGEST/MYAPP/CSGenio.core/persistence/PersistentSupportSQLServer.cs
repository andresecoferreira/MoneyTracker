    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("MNTMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("MNTMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("MNTMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("MNTMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("MNTMQQueues_History", "ANO", "ANO")
                            .Select("MNTMQQueues_History", "USERNAME", "USERNAME")
                            .Select("MNTMQQueues_History", "TABELA", "TABELA")
                            .Select("MNTMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("MNTMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("MNTMQQueues_History", "QUEUE", "QUEUE")
                            .Select("MNTMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("MNTMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("MNTMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("MNTMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("MNTMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("MNTMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("MNTMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("MNTMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("MNTMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.MNTMQQueues_History";
