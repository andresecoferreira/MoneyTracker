...
// USE /[MANUAL MNT INCLUDE_CONTROLLER VIEW_CATMONTH]/

namespace GenioMVC.Controllers
{
	public partial class View_catmonthController : ControllerBase
	{
		private IChatbotService _aiService;
		public View_catmonthController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL MNT CONTROLLER_NAVIGATION VIEW_CATMONTH]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAview_catmonth>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL MNT MANUAL_CONTROLLER VIEW_CATMONTH]/
		...
		{
			return base.GetDocumsTickets("VIEW_CATMONTH", requestModel.FieldName, requestModel.KeyValue);
		}
