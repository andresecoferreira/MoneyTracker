...
namespace GenioMVC.Controllers
{
	public partial class GroupController : ControllerBase
	{
		...
		public GroupController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL MNT CONTROLLER_NAVIGATION GROUP]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAgroup>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL MNT MANUAL_CONTROLLER GROUP]/
		...
		/// <summary>
		/// Recalculate formulas of the "Group" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Group([FromBody]Group_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "group",
				(primaryKey) => Models.Group.Find(primaryKey, UserContext.Current, "FGROUP"),
				(model) => formData.MapToModel(model as Models.Group)
			);
		}
		...
		{
			return base.GetDocumsTickets("GROUP", requestModel.FieldName, requestModel.KeyValue);
		}
