...
namespace GenioMVC.Controllers
{
	public partial class Member_pswController : ControllerBase
	{
		...
		public Member_pswController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL MNT CONTROLLER_NAVIGATION MEMBER_PSW]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAmember_psw>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
...
// USE /[MANUAL MNT MANUAL_CONTROLLER MEMBER_PSW]/
		...
		{
			return base.GetDocumsTickets("MEMBER_PSW", requestModel.FieldName, requestModel.KeyValue);
		}
