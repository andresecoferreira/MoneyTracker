...
namespace GenioMVC.Controllers
{
	public partial class YearController : ControllerBase
	{
		...
		public YearController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL MNT CONTROLLER_NAVIGATION YEAR]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAyear>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
...
// USE /[MANUAL MNT MANUAL_CONTROLLER YEAR]/
		...
		{
			return base.GetDocumsTickets("YEAR", requestModel.FieldName, requestModel.KeyValue);
		}
