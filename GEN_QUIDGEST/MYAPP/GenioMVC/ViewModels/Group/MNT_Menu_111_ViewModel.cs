...
{
	public class MNT_Menu_111_ViewModel : MenuListViewModel<Models.Group>
	{
		/// <summary>
		/// Gets or sets the object that represents the table and its elements.
		/// </summary>
		[JsonPropertyName("table")]
		public TablePartial<MNT_Menu_111_RowViewModel> Menu { get; set; }
		...
		public override string Uuid => "b45f962d-1ce1-4f88-ae85-4f6232ef486c";
		...
		{
// USE /[MANUAL MNT LIST_LIMITS 111]/
		...
		public override int GetCount(User user)
		{
			...
			ListingMVC<CSGenioAgroup> listing = new(fields, null, 1, 1, false, user, true, string.Empty, false);
		...
		public MNT_Menu_111_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="MNT_Menu_111_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public MNT_Menu_111_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public MNT_Menu_111_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			Menu ??= new TablePartial<MNT_Menu_111_RowViewModel>();
			...
			{
				// EPH
				crs = Models.Group.AddEPH<CSGenioAgroup>(ref u, crs, "ML111");
			...
			if (!Navigation.checkFormMode("GROUP", FormMode.New)) // TODO: Check in Duplicate mode
				crs = extendWithZzstateCondition(crs, CSGenioAgroup.FldZzstate, null);
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Group.AddEPH<CSGenioAgroup>(ref u, null, "ML111"));
			}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAgroup> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet mnt_menu_111Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(mnt_menu_111Conds);
			mnt_menu_111Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL MNT OVERRQ 111]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAgroup>(m_userContext, false, ref mnt_menu_111Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL MNT OVERRQLSTEXP 111]/
...
// USE /[MANUAL MNT OVERRQLIST 111]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAgroup.GetInformation(), QMVC_POS_RECORD, sorts, mnt_menu_111Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAgroup> listing = Models.ModelBase.Where<CSGenioAgroup>(m_userContext, distinct, mnt_menu_111Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML111", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
				...
				Menu.Elements = MapMNT_Menu_111(listing);
		...
		private List<MNT_Menu_111_RowViewModel> MapMNT_Menu_111(ListingMVC<CSGenioAgroup> Qlisting)
		{
			List<MNT_Menu_111_RowViewModel> Elements = [];
			int i = 0;
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapMNT_Menu_111(row));
					i++;
				}
			}
		...
		/// to a MNT_Menu_111_RowViewModel object.
		/// </summary>
		/// <param name="row">The row.</param>
		private MNT_Menu_111_RowViewModel MapMNT_Menu_111(CSGenioAgroup row)
		{
			var model = new MNT_Menu_111_RowViewModel(m_userContext, true, _fieldsToSerialize);
			if (row == null)
				return model;
...
// USE /[MANUAL MNT VIEWMODEL_CUSTOM MNT_MENU_111]/
