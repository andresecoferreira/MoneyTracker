...
public class Wd_catmonth_ValCatmonth_RowViewModel : Models.View_catmonth
{
	#region Constructors

	public Wd_catmonth_ValCatmonth_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Wd_catmonth_ValCatmonth_RowViewModel(UserContext userContext, CSGenioAview_catmonth val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
