...
// USE /[MANUAL MNT VIEWMODEL_NEW MEMBER_PSW]/
		...
		public override CrudViewModelValidationResult Validate()
		{
			...
			validator.Required("ValCodpsw", Resources.Resources.USER57012, ViewModelConversion.ToString(ValCodpsw), FieldType.KEY_INT.GetFormatting());
...
// USE /[MANUAL MNT OVERRQ MEMBER_PSW_PSWNOME]/
		...
		{
			var row = GetDependant_Member_pswTablePswNome(this.ValCodpsw);
			try
			{
		...
		protected override object GetViewModelValue(string identifier, object modelValue)
		{
			return identifier switch
			{
				...
				"member_psw.codpsw" => ViewModelConversion.ToString(modelValue),
