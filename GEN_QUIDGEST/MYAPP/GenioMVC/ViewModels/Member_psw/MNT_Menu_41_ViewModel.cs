...
{
	public class MNT_Menu_41_ViewModel : MenuListViewModel<Models.Member_psw>
	{
		/// <summary>
		...
		public override string Uuid => "780be21c-d809-4678-bc4c-4325114acb95";
...
// USE /[MANUAL MNT LIST_LIMITS 41]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Member_psw.AddEPH<CSGenioAmember_psw>(ref u, crs, "ML41");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Member_psw.AddEPH<CSGenioAmember_psw>(ref u, null, "ML41"));
			}
...
// USE /[MANUAL MNT OVERRQ 41]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAmember_psw>(m_userContext, false, ref mnt_menu_41Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML41", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL MNT OVERRQLIST 41]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAmember_psw.GetInformation(), QMVC_POS_RECORD, sorts, mnt_menu_41Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAmember_psw> listing = Models.ModelBase.Where<CSGenioAmember_psw>(m_userContext, distinct, mnt_menu_41Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML41", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<MNT_Menu_41_RowViewModel> MapMNT_Menu_41(ListingMVC<CSGenioAmember_psw> Qlisting)
		{
		...
		private MNT_Menu_41_RowViewModel MapMNT_Menu_41(CSGenioAmember_psw row)
		{
...
// USE /[MANUAL MNT VIEWMODEL_CUSTOM MNT_MENU_41]/
		...
		[
			"Member_psw", "Member_psw.ValCodmember_psw", "Member_psw.ValZzstate", "Member", "Member.ValName", "Member_psw.ValMember_id", "Member_psw.ValCodpsw"
		];
