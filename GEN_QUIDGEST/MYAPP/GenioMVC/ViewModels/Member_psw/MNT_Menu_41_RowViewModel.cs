...
public class MNT_Menu_41_RowViewModel : Models.Member_psw
{
	#region Constructors
	...
	public MNT_Menu_41_RowViewModel(UserContext userContext, CSGenioAmember_psw val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
