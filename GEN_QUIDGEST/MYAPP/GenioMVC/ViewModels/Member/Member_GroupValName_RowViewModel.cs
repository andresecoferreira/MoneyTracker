...
public class Member_GroupValName_RowViewModel : Models.Group
{
	#region Constructors

	public Member_GroupValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Member_GroupValName_RowViewModel(UserContext userContext, CSGenioAgroup val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
