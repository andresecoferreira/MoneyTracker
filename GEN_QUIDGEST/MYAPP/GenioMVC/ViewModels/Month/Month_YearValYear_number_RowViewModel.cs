...
public class Month_YearValYear_number_RowViewModel : Models.Year
{
	#region Constructors

	public Month_YearValYear_number_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Month_YearValYear_number_RowViewModel(UserContext userContext, CSGenioAyear val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
