...
public class MNT_Menu_1411_RowViewModel : Models.Month
{
	#region Constructors

	public MNT_Menu_1411_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public MNT_Menu_1411_RowViewModel(UserContext userContext, CSGenioAmonth val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
