...
public class MNT_Menu_121_RowViewModel : Models.Category_type
{
	#region Constructors

	public MNT_Menu_121_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public MNT_Menu_121_RowViewModel(UserContext userContext, CSGenioAcategory_type val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
