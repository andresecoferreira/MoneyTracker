...
public class Wd_last_expenses_ValField001_RowViewModel : Models.Expense
{
	#region Constructors

	public Wd_last_expenses_ValField001_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Wd_last_expenses_ValField001_RowViewModel(UserContext userContext, CSGenioAexpense val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
