...
public class Expense_Category_typeValName_RowViewModel : Models.Category_type
{
	#region Constructors

	public Expense_Category_typeValName_RowViewModel(UserContext userContext, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}

	public Expense_Category_typeValName_RowViewModel(UserContext userContext, CSGenioAcategory_type val, bool isEmpty = false, string[]? fieldsToSerialize = null) : base(userContext, val, isEmpty, fieldsToSerialize)
	{
		InitRowProperties();
	}
