		...
		<form
			...
			<q-row-container>
				<q-table
					...
					<!-- USE /[MANUAL MNT CUSTOM_TABLE MNT_Menu_121]/ -->
				</q-table>
			</q-row-container>
		</form>
	</teleport>
...
<script>
	...
	import MenuViewModel from './QMenuMNT_121ViewModel.js'

	const requiredTextResources = ['QMenuMNT_121', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_INCLUDEJS MNT_MENU_121]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuMNT_121', false),

				interfaceMetadata: {
					id: 'QMenuMNT_121', // Used for resources
				...
				menuInfo: {
					id: '121',
					isMenuList: true,
					designation: computed(() => this.Resources.CATEGORY_TYPES63920),
					acronym: 'MNT_121',
					name: 'CATEGORY_TYPE',
					route: 'menu-MNT_121',
					order: '121',
				...
				controls: {
					menu: new controlClass.TableSpecialRenderingControl({
						...
						config: {
							...
							viewManagement: '',
							showLimitsInfo: true,
							tableTitle: computed(() => this.Resources.CATEGORY_TYPES63920),
							...
							formsDefinition: {
								'CATEGORY_TYPE': {
									fnKeySelector: (row) => row.Fields.ValCodcategory_type,
									isPopup: false
								},
							},
						...
						uuid: '3eb026c3-e7ba-4d49-8b5e-5fbbdd29f9d6',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_CODEJS MNT_MENU_121]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT COMPONENT_BEFORE_UNMOUNT MNT_MENU_121]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FUNCTIONS_JS MNT_121]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT LISTING_CODEJS MNT_MENU_121]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
