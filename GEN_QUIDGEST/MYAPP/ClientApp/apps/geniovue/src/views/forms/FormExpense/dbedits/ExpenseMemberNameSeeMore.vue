<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-expense-member-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['EXPENSE__MEMBER__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ExpenseMemberNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('EXPENSE__MEMBER__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'EXPENSE__MEMBER__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'EXPENSE__MEMBER__NAME_SeeMore',
					name: 'EXPENSE__MEMBER__NAME_SeeMore',
					controller: 'EXPENSE',
					action: 'EXPENSE_MemberValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-expense-member-name',
				dismissAction: this.close,
				returnElement: 'EXPENSE__MEMBER__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-expense-member-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Expense_Expense_MemberValName',
