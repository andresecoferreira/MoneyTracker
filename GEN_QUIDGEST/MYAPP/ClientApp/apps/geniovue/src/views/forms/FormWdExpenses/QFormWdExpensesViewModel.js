...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		_merge(this.modelInfo, {
			...
			area: 'EXPENSE',
			actions: {
				recalculateFormulas: 'RecalculateFormulas_Wd_expenses',
				updateFilesTickets: 'UpdateFilesTicketsWd_expenses',
				setFile: 'SetFileWd_expenses'
			}
		})
	...
	/**
	 * Creates a clone of the current QFormWdExpensesViewModel instance.
	 * @returns {QFormWdExpensesViewModel} A new instance of QFormWdExpensesViewModel
	 */
	clone()
	{
