	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row v-if="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID.isVisible">
					<q-col
						v-if="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID.isVisible"
						cols="auto">
						<base-input-structure
							v-if="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID.isVisible"
							class="i-text"
							v-bind="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID"
							v-on="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID.handlers"
							:loading="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID.props.loading"
							:reporting-mode-on="reportingModeCAV"
							:suggestion-mode-on="suggestionModeOn">
							<q-numeric-input
								v-if="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID.isVisible"
								v-bind="controls.INVESTMENT__INVESTMENT__INVESTMENT_ID.props"
								@update:model-value="model.ValInvestment_id.fnUpdateValue" />
						</base-input-structure>
					</q-col>
				</q-row>
				<q-row v-if="controls.INVESTMENT__PSEUD__NEWGRP01.isVisible">
					<q-col v-if="controls.INVESTMENT__PSEUD__NEWGRP01.isVisible">
						<q-group-box-container
							v-if="controls.INVESTMENT__PSEUD__NEWGRP01.isVisible"
							id="INVESTMENT__PSEUD__NEWGRP01"
							...
							<q-row v-if="controls.INVESTMENT__CATEGORY_TYPE__NAME.isVisible || controls.INVESTMENT__CATEGORY__NAME.isVisible">
								...
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__CATEGORY__NAME.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__CATEGORY__NAME"
										v-on="controls.INVESTMENT__CATEGORY__NAME.handlers"
										:loading="controls.INVESTMENT__CATEGORY__NAME.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-lookup
											v-if="controls.INVESTMENT__CATEGORY__NAME.isVisible"
											v-bind="controls.INVESTMENT__CATEGORY__NAME.props"
											v-on="controls.INVESTMENT__CATEGORY__NAME.handlers" />
										<q-see-more-investment-category-name
											v-if="controls.INVESTMENT__CATEGORY__NAME.seeMoreIsVisible"
											v-bind="controls.INVESTMENT__CATEGORY__NAME.seeMoreParams"
											v-on="controls.INVESTMENT__CATEGORY__NAME.handlers" />
									</base-input-structure>
								</q-col>
							</q-row>
							<q-row v-if="controls.INVESTMENT__MEMBER__NAME.isVisible || controls.INVESTMENT__SOURCE__TITLE.isVisible">
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__MEMBER__NAME.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__MEMBER__NAME"
										v-on="controls.INVESTMENT__MEMBER__NAME.handlers"
										:loading="controls.INVESTMENT__MEMBER__NAME.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-lookup
											v-if="controls.INVESTMENT__MEMBER__NAME.isVisible"
											v-bind="controls.INVESTMENT__MEMBER__NAME.props"
											v-on="controls.INVESTMENT__MEMBER__NAME.handlers" />
										<q-see-more-investment-member-name
											v-if="controls.INVESTMENT__MEMBER__NAME.seeMoreIsVisible"
								...
								<q-col
									...
									<base-input-structure
										...
										:loading="controls.INVESTMENT__SOURCE__TITLE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-lookup
											v-if="controls.INVESTMENT__SOURCE__TITLE.isVisible"
											v-bind="controls.INVESTMENT__SOURCE__TITLE.props"
											v-on="controls.INVESTMENT__SOURCE__TITLE.handlers" />
										<q-see-more-investment-source-title
											v-if="controls.INVESTMENT__SOURCE__TITLE.seeMoreIsVisible"
							...
							<q-row v-if="controls.INVESTMENT__INVESTMENT__VALUE.isVisible || controls.INVESTMENT__INVESTMENT__DATE.isVisible">
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__INVESTMENT__VALUE.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__INVESTMENT__VALUE"
										v-on="controls.INVESTMENT__INVESTMENT__VALUE.handlers"
										:loading="controls.INVESTMENT__INVESTMENT__VALUE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-numeric-input
											v-if="controls.INVESTMENT__INVESTMENT__VALUE.isVisible"
								...
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__INVESTMENT__DATE.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__INVESTMENT__DATE"
										v-on="controls.INVESTMENT__INVESTMENT__DATE.handlers"
										:loading="controls.INVESTMENT__INVESTMENT__DATE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-date-time-picker
											v-if="controls.INVESTMENT__INVESTMENT__DATE.isVisible"
											v-bind="controls.INVESTMENT__INVESTMENT__DATE.props"
							...
							<q-row v-if="controls.INVESTMENT__INVESTMENT__DESCRIPTION.isVisible">
								<q-col
									v-if="controls.INVESTMENT__INVESTMENT__DESCRIPTION.isVisible"
									cols="auto">
									<base-input-structure
										v-if="controls.INVESTMENT__INVESTMENT__DESCRIPTION.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__INVESTMENT__DESCRIPTION"
										v-on="controls.INVESTMENT__INVESTMENT__DESCRIPTION.handlers"
										:loading="controls.INVESTMENT__INVESTMENT__DESCRIPTION.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.INVESTMENT__INVESTMENT__DESCRIPTION.props"
											@blur="onBlur(controls.INVESTMENT__INVESTMENT__DESCRIPTION, model.ValDescription.value)"
											@change="model.ValDescription.fnUpdateValueOnChange" />
									</base-input-structure>
								</q-col>
							</q-row>
							<!-- End INVESTMENT__PSEUD__NEWGRP01 -->
						</q-group-box-container>
					</q-col>
				</q-row>
				<q-row v-if="controls.INVESTMENT__PSEUD__NEWGRP02.isVisible">
					<q-col v-if="controls.INVESTMENT__PSEUD__NEWGRP02.isVisible">
						<q-group-box-container
							v-if="controls.INVESTMENT__PSEUD__NEWGRP02.isVisible"
							id="INVESTMENT__PSEUD__NEWGRP02"
							v-bind="controls.INVESTMENT__PSEUD__NEWGRP02"
							:is-visible="controls.INVESTMENT__PSEUD__NEWGRP02.isVisible">
							...
							<q-row v-if="controls.INVESTMENT__INVESTMENT__CREATED_BY.isVisible || controls.INVESTMENT__INVESTMENT__CREATED_AT.isVisible">
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__INVESTMENT__CREATED_BY.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__INVESTMENT__CREATED_BY"
										v-on="controls.INVESTMENT__INVESTMENT__CREATED_BY.handlers"
										:loading="controls.INVESTMENT__INVESTMENT__CREATED_BY.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.INVESTMENT__INVESTMENT__CREATED_BY.props"
								...
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__INVESTMENT__CREATED_AT.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__INVESTMENT__CREATED_AT"
										v-on="controls.INVESTMENT__INVESTMENT__CREATED_AT.handlers"
										:loading="controls.INVESTMENT__INVESTMENT__CREATED_AT.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-date-time-picker
											v-if="controls.INVESTMENT__INVESTMENT__CREATED_AT.isVisible"
											v-bind="controls.INVESTMENT__INVESTMENT__CREATED_AT.props"
							...
							<q-row v-if="controls.INVESTMENT__INVESTMENT__UPDATED_BY.isVisible || controls.INVESTMENT__INVESTMENT__UPDATED_AT.isVisible">
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__INVESTMENT__UPDATED_BY.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__INVESTMENT__UPDATED_BY"
										v-on="controls.INVESTMENT__INVESTMENT__UPDATED_BY.handlers"
										:loading="controls.INVESTMENT__INVESTMENT__UPDATED_BY.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.INVESTMENT__INVESTMENT__UPDATED_BY.props"
								...
								<q-col
									...
									<base-input-structure
										v-if="controls.INVESTMENT__INVESTMENT__UPDATED_AT.isVisible"
										class="i-text"
										v-bind="controls.INVESTMENT__INVESTMENT__UPDATED_AT"
										v-on="controls.INVESTMENT__INVESTMENT__UPDATED_AT.handlers"
										:loading="controls.INVESTMENT__INVESTMENT__UPDATED_AT.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-date-time-picker
											v-if="controls.INVESTMENT__INVESTMENT__UPDATED_AT.isVisible"
											v-bind="controls.INVESTMENT__INVESTMENT__UPDATED_AT.props"
							...
							<!-- End INVESTMENT__PSEUD__NEWGRP02 -->
						</q-group-box-container>
					</q-col>
				</q-row>
			</template>
...
<script>
	...
	import FormViewModel from './QFormInvestmentViewModel.js'

	const requiredTextResources = ['QFormInvestment', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_INCLUDEJS INVESTMENT]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormInvestment', false),

				interfaceMetadata: {
					id: 'QFormInvestment', // Used for resources
				...
				formInfo: {
					type: 'normal',
					name: 'INVESTMENT',
					route: 'form-INVESTMENT',
					area: 'INVESTMENT',
					primaryKey: 'ValCodinvestment',
					designation: computed(() => this.Resources.INVESTMENT14761),
				...
				controls: {
					INVESTMENT__INVESTMENT__INVESTMENT_ID: new fieldControlClass.NumberControl({
						modelField: 'ValInvestment_id',
						valueChangeEvent: 'fieldChange:investment.investment_id',
						id: 'INVESTMENT__INVESTMENT__INVESTMENT_ID',
						name: 'INVESTMENT_ID',
						size: 'mini',
					...
					INVESTMENT__PSEUD__NEWGRP01: new fieldControlClass.GroupControl({
						id: 'INVESTMENT__PSEUD__NEWGRP01',
						name: 'NEWGRP01',
						size: 'block',
						label: computed(() => this.Resources.INFO02225),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						isCollapsible: false,
						anchored: false,
					...
					INVESTMENT__CATEGORY__NAME: new fieldControlClass.LookupControl({
						modelField: 'TableCategoryName',
						valueChangeEvent: 'fieldChange:category.name',
						id: 'INVESTMENT__CATEGORY__NAME',
						name: 'NAME',
						size: 'large',
						...
						lookupKeyModelField: {
							name: 'ValCategory_id',
							dependencyEvent: 'fieldChange:investment.category_id'
						},
						dependentFields: () => ({
					...
					INVESTMENT__MEMBER__NAME: new fieldControlClass.LookupControl({
						...
						lookupKeyModelField: {
							name: 'ValMember_id',
							dependencyEvent: 'fieldChange:investment.member_id'
						},
						dependentFields: () => ({
					...
					INVESTMENT__SOURCE__TITLE: new fieldControlClass.LookupControl({
						...
						lookupKeyModelField: {
							name: 'ValSource_id',
							dependencyEvent: 'fieldChange:investment.source_id'
						},
						dependentFields: () => ({
					...
					INVESTMENT__INVESTMENT__DATE: new fieldControlClass.DateControl({
						modelField: 'ValDate',
					...
					INVESTMENT__INVESTMENT__DESCRIPTION: new fieldControlClass.StringControl({
						modelField: 'ValDescription',
						valueChangeEvent: 'fieldChange:investment.description',
						id: 'INVESTMENT__INVESTMENT__DESCRIPTION',
						name: 'DESCRIPTION',
						size: 'xxlarge',
					...
					INVESTMENT__PSEUD__NEWGRP02: new fieldControlClass.GroupControl({
						id: 'INVESTMENT__PSEUD__NEWGRP02',
						name: 'NEWGRP02',
						size: 'block',
						...
						isCollapsible: false,
						anchored: false,
						directChildren: ['INVESTMENT__INVESTMENT__CREATED_BY', 'INVESTMENT__INVESTMENT__CREATED_AT', 'INVESTMENT__INVESTMENT__UPDATED_BY', 'INVESTMENT__INVESTMENT__UPDATED_AT'],
						controlLimits: [
						],
					}, this),
					INVESTMENT__INVESTMENT__CREATED_BY: new fieldControlClass.StringControl({
						modelField: 'ValCreated_by',
						valueChangeEvent: 'fieldChange:investment.created_by',
						id: 'INVESTMENT__INVESTMENT__CREATED_BY',
						name: 'CREATED_BY',
						size: 'xxlarge',
						label: computed(() => this.Resources.CREATED_BY58035),
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'INVESTMENT__PSEUD__NEWGRP02',
						maxLength: 100,
						controlLimits: [
						],
					}, this),
					INVESTMENT__INVESTMENT__CREATED_AT: new fieldControlClass.DateControl({
						modelField: 'ValCreated_at',
						valueChangeEvent: 'fieldChange:investment.created_at',
						id: 'INVESTMENT__INVESTMENT__CREATED_AT',
						name: 'CREATED_AT',
						size: 'small',
					...
					INVESTMENT__INVESTMENT__UPDATED_BY: new fieldControlClass.StringControl({
						modelField: 'ValUpdated_by',
						valueChangeEvent: 'fieldChange:investment.updated_by',
						id: 'INVESTMENT__INVESTMENT__UPDATED_BY',
						name: 'UPDATED_BY',
						size: 'xxlarge',
					...
					INVESTMENT__INVESTMENT__UPDATED_AT: new fieldControlClass.DateControl({
						modelField: 'ValUpdated_at',
						valueChangeEvent: 'fieldChange:investment.updated_at',
						id: 'INVESTMENT__INVESTMENT__UPDATED_AT',
						name: 'UPDATED_AT',
						size: 'small',
				...
				groupFields: readonly([
					'INVESTMENT__PSEUD__NEWGRP01',
					'INVESTMENT__PSEUD__NEWGRP02',
				]),
				...
				dataApi: {
					...
					keys: {
						/** The primary key of the INVESTMENT table */
						get investment() { return vm.model.ValCodinvestment },
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_CODEJS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT COMPONENT_BEFORE_UNMOUNT INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_LOAD_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_LOADED_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_APPLY_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_APPLY_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_SAVE_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_SAVE_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_DEL_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_DEL_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_EXIT_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_EXIT_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT DLGUPDT INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT CTRLBLR INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			...
			{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT CTRLUPD INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FUNCTIONS_JS INVESTMENT]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
