<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-investment-category-type-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['INVESTMENT__CATEGORY_TYPE__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'InvestmentCategoryTypeNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('INVESTMENT__CATEGORY_TYPE__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'INVESTMENT__CATEGORY_TYPE__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'INVESTMENT__CATEGORY_TYPE__NAME_SeeMore',
					name: 'INVESTMENT__CATEGORY_TYPE__NAME_SeeMore',
					controller: 'INVESTMENT',
					action: 'INVESTMENT_Category_typeValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-investment-category-type-name',
				dismissAction: this.close,
				returnElement: 'INVESTMENT__CATEGORY_TYPE__NAME_see-more_button'
			}
			const props = {
				class: 'q-dialog-see-more',
				title: computed(() => this.Resources.CATEGORY_TYPES63920),
				buttons: [
					{
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-investment-category-type-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Investment_Category_typeValName',
							serverMode: true,
						...
						uuid: 'Investment_Investment_Category_typeValName',
