...
export default class ViewModel extends FormViewModelBase
{
	...
	constructor(vueContext, options, values)
	{
		...
		this.stopWatchers.push(watch(() => this.ValGroup_id.value, (newValue, oldValue) => this.onUpdate('income.group_id', this.ValGroup_id, newValue, oldValue)))
		...
		this.stopWatchers.push(watch(() => this.ValType_id.value, (newValue, oldValue) => this.onUpdate('income.type_id', this.ValType_id, newValue, oldValue)))
