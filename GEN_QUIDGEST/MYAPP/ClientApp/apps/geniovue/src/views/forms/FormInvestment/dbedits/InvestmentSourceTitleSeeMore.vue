<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-investment-source-title-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['INVESTMENT__SOURCE__TITLE_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'InvestmentSourceTitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('INVESTMENT__SOURCE__TITLE_SeeMore', false),

				interfaceMetadata: {
					id: 'INVESTMENT__SOURCE__TITLE_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'INVESTMENT__SOURCE__TITLE_SeeMore',
					name: 'INVESTMENT__SOURCE__TITLE_SeeMore',
					controller: 'INVESTMENT',
					action: 'INVESTMENT_SourceValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-investment-source-title',
				dismissAction: this.close,
				returnElement: 'INVESTMENT__SOURCE__TITLE_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-investment-source-title')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Investment_SourceValTitle',
							serverMode: true,
						...
						uuid: 'Investment_Investment_SourceValTitle',
