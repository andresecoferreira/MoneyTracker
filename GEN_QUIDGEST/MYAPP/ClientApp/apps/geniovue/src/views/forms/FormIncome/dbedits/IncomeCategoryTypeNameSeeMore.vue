<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-income-category-type-name-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['INCOME__CATEGORY_TYPE__NAME_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'IncomeCategoryTypeNameSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('INCOME__CATEGORY_TYPE__NAME_SeeMore', false),

				interfaceMetadata: {
					id: 'INCOME__CATEGORY_TYPE__NAME_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'INCOME__CATEGORY_TYPE__NAME_SeeMore',
					name: 'INCOME__CATEGORY_TYPE__NAME_SeeMore',
					controller: 'INCOME',
					action: 'INCOME_Category_typeValName'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-income-category-type-name',
				dismissAction: this.close,
				returnElement: 'INCOME__CATEGORY_TYPE__NAME_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-income-category-type-name')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Income_Category_typeValName',
							serverMode: true,
						...
						uuid: 'Income_Income_Category_typeValName',
