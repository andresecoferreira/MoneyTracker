	...
	<teleport
		...
		<q-container
			...
			<template v-if="formControl.initialized && showFormBody">
				<q-row v-if="controls.INCOME__INCOME__INCOME_ID.isVisible">
					<q-col
						v-if="controls.INCOME__INCOME__INCOME_ID.isVisible"
						cols="auto">
						<base-input-structure
							v-if="controls.INCOME__INCOME__INCOME_ID.isVisible"
							class="i-text"
							v-bind="controls.INCOME__INCOME__INCOME_ID"
							v-on="controls.INCOME__INCOME__INCOME_ID.handlers"
							:loading="controls.INCOME__INCOME__INCOME_ID.props.loading"
							:reporting-mode-on="reportingModeCAV"
							:suggestion-mode-on="suggestionModeOn">
							<q-numeric-input
								v-if="controls.INCOME__INCOME__INCOME_ID.isVisible"
								v-bind="controls.INCOME__INCOME__INCOME_ID.props"
								@update:model-value="model.ValIncome_id.fnUpdateValue" />
						</base-input-structure>
					</q-col>
				</q-row>
				<q-row v-if="controls.INCOME__PSEUDNEWGRP01.isVisible">
					<q-col v-if="controls.INCOME__PSEUDNEWGRP01.isVisible">
						<q-group-box-container
							v-if="controls.INCOME__PSEUDNEWGRP01.isVisible"
							id="INCOME__PSEUDNEWGRP01"
							...
							<q-row v-if="controls.INCOME__CATEGORY_TYPE__NAME.isVisible || controls.INCOME__CATEGORY__NAME.isVisible">
								<q-col
									...
									<base-input-structure
										...
										class="i-text"
										v-bind="controls.INCOME__CATEGORY__NAME"
										v-on="controls.INCOME__CATEGORY__NAME.handlers"
										:loading="controls.INCOME__CATEGORY__NAME.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-lookup
											v-if="controls.INCOME__CATEGORY__NAME.isVisible"
											v-bind="controls.INCOME__CATEGORY__NAME.props"
											v-on="controls.INCOME__CATEGORY__NAME.handlers" />
										<q-see-more-income-category-name
											v-if="controls.INCOME__CATEGORY__NAME.seeMoreIsVisible"
											v-bind="controls.INCOME__CATEGORY__NAME.seeMoreParams"
											v-on="controls.INCOME__CATEGORY__NAME.handlers" />
									</base-input-structure>
								</q-col>
							</q-row>
							<q-row v-if="controls.INCOME__MEMBER__NAME.isVisible || controls.INCOME__SOURCE__TITLE.isVisible">
								<q-col
									...
									<base-input-structure
										...
										class="i-text"
										v-bind="controls.INCOME__MEMBER__NAME"
										v-on="controls.INCOME__MEMBER__NAME.handlers"
										:loading="controls.INCOME__MEMBER__NAME.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-lookup
											v-if="controls.INCOME__MEMBER__NAME.isVisible"
											v-bind="controls.INCOME__MEMBER__NAME.props"
											v-on="controls.INCOME__MEMBER__NAME.handlers" />
										<q-see-more-income-member-name
											v-if="controls.INCOME__MEMBER__NAME.seeMoreIsVisible"
									...
									<base-input-structure
										...
										:loading="controls.INCOME__SOURCE__TITLE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-lookup
											v-if="controls.INCOME__SOURCE__TITLE.isVisible"
											v-bind="controls.INCOME__SOURCE__TITLE.props"
											v-on="controls.INCOME__SOURCE__TITLE.handlers" />
										<q-see-more-income-source-title
											v-if="controls.INCOME__SOURCE__TITLE.seeMoreIsVisible"
							...
							<q-row v-if="controls.INCOME__INCOME__VALUE.isVisible || controls.INCOME__INCOME__DATE.isVisible">
								<q-col
									...
									<base-input-structure
										...
										class="i-text"
										v-bind="controls.INCOME__INCOME__VALUE"
										v-on="controls.INCOME__INCOME__VALUE.handlers"
										:loading="controls.INCOME__INCOME__VALUE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-numeric-input
											v-if="controls.INCOME__INCOME__VALUE.isVisible"
									...
									<base-input-structure
										...
										class="i-text"
										v-bind="controls.INCOME__INCOME__DATE"
										v-on="controls.INCOME__INCOME__DATE.handlers"
										:loading="controls.INCOME__INCOME__DATE.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-date-time-picker
											v-if="controls.INCOME__INCOME__DATE.isVisible"
											v-bind="controls.INCOME__INCOME__DATE.props"
							...
							<!-- End INCOME__PSEUDNEWGRP01 -->
						</q-group-box-container>
					</q-col>
				</q-row>
				<q-row v-if="controls.INCOME__PSEUDNEWGRP02.isVisible">
					<q-col v-if="controls.INCOME__PSEUDNEWGRP02.isVisible">
						<q-group-box-container
							v-if="controls.INCOME__PSEUDNEWGRP02.isVisible"
							id="INCOME__PSEUDNEWGRP02"
							...
							<q-row v-if="controls.INCOME__INCOME__CREATED_BY.isVisible || controls.INCOME__INCOME__CREATED_AT.isVisible">
								<q-col
									...
									<base-input-structure
										...
										class="i-text"
										v-bind="controls.INCOME__INCOME__CREATED_BY"
										v-on="controls.INCOME__INCOME__CREATED_BY.handlers"
										:loading="controls.INCOME__INCOME__CREATED_BY.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.INCOME__INCOME__CREATED_BY.props"
									...
									<base-input-structure
										...
										class="i-text"
										v-bind="controls.INCOME__INCOME__CREATED_AT"
										v-on="controls.INCOME__INCOME__CREATED_AT.handlers"
										:loading="controls.INCOME__INCOME__CREATED_AT.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-date-time-picker
											v-if="controls.INCOME__INCOME__CREATED_AT.isVisible"
											v-bind="controls.INCOME__INCOME__CREATED_AT.props"
							...
							<q-row v-if="controls.INCOME__INCOME__UPDATED_BY.isVisible || controls.INCOME__INCOME__UPDATED_AT.isVisible">
								<q-col
									...
									cols="auto">
									<base-input-structure
										v-if="controls.INCOME__INCOME__UPDATED_BY.isVisible"
										class="i-text"
										v-bind="controls.INCOME__INCOME__UPDATED_BY"
										v-on="controls.INCOME__INCOME__UPDATED_BY.handlers"
										:loading="controls.INCOME__INCOME__UPDATED_BY.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-text-field
											v-bind="controls.INCOME__INCOME__UPDATED_BY.props"
											@blur="onBlur(controls.INCOME__INCOME__UPDATED_BY, model.ValUpdated_by.value)"
											@change="model.ValUpdated_by.fnUpdateValueOnChange" />
									</base-input-structure>
									<base-input-structure
										v-if="controls.INCOME__INCOME__UPDATED_AT.isVisible"
										class="i-text"
										v-bind="controls.INCOME__INCOME__UPDATED_AT"
										v-on="controls.INCOME__INCOME__UPDATED_AT.handlers"
										:loading="controls.INCOME__INCOME__UPDATED_AT.props.loading"
										:reporting-mode-on="reportingModeCAV"
										:suggestion-mode-on="suggestionModeOn">
										<q-date-time-picker
											v-if="controls.INCOME__INCOME__UPDATED_AT.isVisible"
											v-bind="controls.INCOME__INCOME__UPDATED_AT.props"
...
<script>
	...
	import FormViewModel from './QFormIncomeViewModel.js'

	const requiredTextResources = ['QFormIncome', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_INCLUDEJS INCOME]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QFormIncome', false),

				interfaceMetadata: {
					id: 'QFormIncome', // Used for resources
				...
				formInfo: {
					...
					route: 'form-INCOME',
					area: 'INCOME',
					primaryKey: 'ValCodincome',
					designation: computed(() => this.Resources.INCOME04695),
				...
				controls: {
					INCOME__INCOME__INCOME_ID: new fieldControlClass.NumberControl({
						modelField: 'ValIncome_id',
						valueChangeEvent: 'fieldChange:income.income_id',
						id: 'INCOME__INCOME__INCOME_ID',
						name: 'INCOME_ID',
						size: 'mini',
					...
					INCOME__PSEUDNEWGRP01: new fieldControlClass.GroupControl({
						id: 'INCOME__PSEUDNEWGRP01',
						name: 'NEWGRP01',
						size: 'block',
					...
					INCOME__CATEGORY__NAME: new fieldControlClass.LookupControl({
						modelField: 'TableCategoryName',
						valueChangeEvent: 'fieldChange:category.name',
						id: 'INCOME__CATEGORY__NAME',
						name: 'NAME',
						size: 'large',
						...
						lookupKeyModelField: {
							name: 'ValCategory_id',
							dependencyEvent: 'fieldChange:income.category_id'
						},
						dependentFields: () => ({
					...
					INCOME__MEMBER__NAME: new fieldControlClass.LookupControl({
						...
						lookupKeyModelField: {
							name: 'ValMember_id',
							dependencyEvent: 'fieldChange:income.member_id'
						},
						dependentFields: () => ({
					...
					INCOME__SOURCE__TITLE: new fieldControlClass.LookupControl({
						...
						lookupKeyModelField: {
							name: 'ValSource_id',
							dependencyEvent: 'fieldChange:income.source_id'
						},
						dependentFields: () => ({
						...
						controlLimits: [
							{
								...
								dependencyEvents: ['fieldChange:income.member_id'],
								dependencyField: 'INCOME.MEMBER_ID',
					...
					INCOME__INCOME__DESCRIPTION: new fieldControlClass.StringControl({
						modelField: 'ValDescription',
						valueChangeEvent: 'fieldChange:income.description',
						id: 'INCOME__INCOME__DESCRIPTION',
						name: 'DESCRIPTION',
						size: 'xxlarge',
					...
					INCOME__PSEUDNEWGRP02: new fieldControlClass.GroupControl({
						id: 'INCOME__PSEUDNEWGRP02',
						name: 'NEWGRP02',
						size: 'block',
						...
						isCollapsible: false,
						anchored: false,
						directChildren: ['INCOME__INCOME__CREATED_BY', 'INCOME__INCOME__CREATED_AT', 'INCOME__INCOME__UPDATED_BY', 'INCOME__INCOME__UPDATED_AT'],
						controlLimits: [
						],
					}, this),
					INCOME__INCOME__CREATED_BY: new fieldControlClass.StringControl({
						...
						placeholder: '',
						labelPosition: computed(() => this.labelAlignment.topleft),
						container: 'INCOME__PSEUDNEWGRP02',
						maxLength: 100,
						controlLimits: [
						],
					}, this),
					INCOME__INCOME__CREATED_AT: new fieldControlClass.DateControl({
					...
					INCOME__INCOME__UPDATED_BY: new fieldControlClass.StringControl({
					...
					INCOME__INCOME__UPDATED_AT: new fieldControlClass.DateControl({
				...
				groupFields: readonly([
					'INCOME__PSEUDNEWGRP01',
					'INCOME__PSEUDNEWGRP02',
				]),
				...
				dataApi: {
					...
					keys: {
						/** The primary key of the INCOME table */
						get income() { return vm.model.ValCodincome },
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_CODEJS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT COMPONENT_BEFORE_UNMOUNT INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_LOAD_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FORM_LOADED_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_APPLY_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_APPLY_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_SAVE_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_SAVE_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_DEL_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_DEL_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT BEFORE_EXIT_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT AFTER_EXIT_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
			},
...
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL MNT FUNCTIONS_JS INCOME]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
