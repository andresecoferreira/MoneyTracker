...
{
	/// <summary>
	/// Defines the EPH conditions for module MNT
	/// </summary>
	public class MNTEPH : EPH
	{
        /// <summary>
		...
		static MNTEPH ()
		{
			...
			//PHE in role Member            
            ephsPorModulo["50"] = [
                new EPHCondition("MEMBERPSW", "MNT", "mntmember_psw", "member_psw", "member_id", "member_psw", "member_id", FieldType.KEY_INT, ""),
            ];
