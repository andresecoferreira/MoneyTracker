...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("group", new Relation("MNT", "mntinvestment", "investment", "codinvestment", "group_id", "MNT", "mntgroup", "group", "codgroup", "codgroup"));
		...
		private static void InicializaFormulas(AreaInfo info)
		{
			...
			info.RelatedSumArgs.Add( new RelatedSumArgument("investment", "member", "investment", "value", '+', true));
		...
		private static FieldRef m_fldGroup_id = new FieldRef("investment", "group_id");
