...
namespace CSGenio.business
{
	...
	/// Income
	/// </summary>
	public class CSGenioAincome : DbArea
	{
		/// <summary>
		...
		public CSGenioAincome(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL MNT CONSTRUTOR INCOME]/
		}

		public CSGenioAincome(User user) : this(user, user.CurrentModule)
		{
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "codincome", FieldType.KEY_INT);
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "income_id", FieldType.NUMERIC);
			...
			Qfield.DefaultValue = new DefaultValue(DefaultValue.getGreaterPlus1_int, "income_id");
			info.RegisterFieldDB(Qfield);
		...
		private static void InicializaFormulas(AreaInfo info)
		{
			...
			info.RelatedSumArgs.Add( new RelatedSumArgument("income", "member", "income", "value", '+', true));
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.QSystem="MNT";
			info.TableName="mntincome";
			info.ShadowTabName="";
			info.ShadowTabKeyName="";

			info.PrimaryKeyName="codincome";
			info.HumanKeyName="income_id,".TrimEnd(',');
			info.Alias="income";
			info.IsDomain = true;
			info.PersistenceType = PersistenceType.Database;
			info.AreaDesignation="Income";
			info.AreaPluralDesignation="Incomes";
			info.DescriptionCav="INCOME04695";
		...
		public static FieldRef FldCodincome { get { return m_fldCodincome; } }
		private static FieldRef m_fldCodincome = new FieldRef("income", "codincome");

		/// <summary>Field : "" Tipo: "+" Formula:  ""</summary>
		public string ValCodincome
		{
			get { return (string)returnValueField(FldCodincome); }
			set { insertNameValueField(FldCodincome, value); }
		}

		/// <summary>Field : "Id" Tipo: "N" Formula:  ""</summary>
		public static FieldRef FldIncome_id { get { return m_fldIncome_id; } }
		private static FieldRef m_fldIncome_id = new FieldRef("income", "income_id");

		/// <summary>Field : "Id" Tipo: "N" Formula:  ""</summary>
		public decimal ValIncome_id
		{
			get { return (decimal)returnValueField(FldIncome_id); }
			set { insertNameValueField(FldIncome_id, value); }
		}

		/// <summary>Field : "Category" Tipo: "CE" Formula:  ""</summary>
		public static FieldRef FldCategory_id { get { return m_fldCategory_id; } }
		private static FieldRef m_fldCategory_id = new FieldRef("income", "category_id");
		...
		private static FieldRef m_fldMember_id = new FieldRef("income", "member_id");
		...
		private static FieldRef m_fldSource_id = new FieldRef("income", "source_id");
		...
		private static FieldRef m_fldType_id = new FieldRef("income", "type_id");
		...
		private static FieldRef m_fldValue = new FieldRef("income", "value");
		...
		private static FieldRef m_fldDescription = new FieldRef("income", "description");
		...
		private static FieldRef m_fldDate = new FieldRef("income", "date");
		...
		private static FieldRef m_fldUpdated_at = new FieldRef("income", "updated_at");
		...
		private static FieldRef m_fldCreated_at = new FieldRef("income", "created_at");
		...
		private static FieldRef m_fldCreated_by = new FieldRef("income", "created_by");
		...
		private static FieldRef m_fldUpdated_by = new FieldRef("income", "updated_by");
        ...
        public static CSGenioAincome search(PersistentSupport sp, string key, User user, string[] fields = null, bool forUpdate = false)
        {
			if (string.IsNullOrEmpty(key))
				return null;

		    CSGenioAincome area = new CSGenioAincome(user, user.CurrentModule);
        ...
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static List<CSGenioAincome> searchList(PersistentSupport sp, User user, CriteriaSet where, string[] fields = null, bool distinct = false, bool noLock = false)
        {
				return sp.searchListWhere<CSGenioAincome>(where, user, fields, distinct, noLock);
        }
        ...
        /// <returns>A list of area records with all fields populated</returns>
        /// <remarks>Persistence operations should not be used on a partially positioned register</remarks>
        public static void searchListAdvancedWhere(PersistentSupport sp, User user, CriteriaSet where, ListingMVC<CSGenioAincome> listing)
        {
			sp.searchListAdvancedWhere<CSGenioAincome>(where, listing);
        }
