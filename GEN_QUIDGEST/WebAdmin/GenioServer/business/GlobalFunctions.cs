...
// USE /[MANUAL MNT IMPORTS]/
// USE /[MANUAL MNT IMPORTS GlobalFunctions]/
...
// USE /[MANUAL MNT ONASSINA]/
        ...
        private static readonly Dictionary<string, string> MYAPP_THEME_VARIABLES = new Dictionary<string, string>()
        {
            ...
            { "$action-focus-color", "#047857" },
            { "$input-focus-color", "rgba(14, 165, 164, 0.35)" },
            { "$button-focus-color", "rgba(4, 120, 87, 0.35)" },
            { "$body-bg", "$F8FAFC" },
            { "$body-color", "#0F172A" },
