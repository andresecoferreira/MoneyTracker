...
SET @SQL = N'
CREATE DATABASE [ASPStateMNT]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateMNT'', FILENAME = N''' + @SQLDataFolder + 'ASPStateMNT.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateMNT_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateMNT_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateMNT_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateMNT_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateMNT_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateMNT] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateMNT] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
